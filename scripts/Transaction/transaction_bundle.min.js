...
//!short_view ? "7.5%" : "12.5%"));
if(i.appendChild(Utilities.CreateTableCell("th","$ Check","has-text-right","7.5%")),i.appendChild(Utilities.CreateTableCell("th","$ Cash","has-text-right","7.5%")),i.appendChild(Utilities.CreateTableCell("th","$ Total","has-text-right","7.5%")),!t){let t=Utilities.CreateTableCell("th","Pg: "+n.current_page.toString(),"has-text-centered","5%");i.appendChild(t)}return r}static CreateTransactionListRow(t,r){let u=document.createElement("tr");u.appendChild(Utilities.CreateTableCell("td",Utilities.Format_DateTime(t.created_on),"has-text-left"));u.appendChild(Utilities.CreateTableCell("td",t.transaction_type,"has-text-centered"));let f=document.createElement("a");f.appendChild(document.createTextNode(t.transaction_number));f.onclick=()=>{n.ShowReceiptDetail(t.transaction_id)};let o=Utilities.CreateTableCell("td","","has-text-left");o.appendChild(f);u.appendChild(o);let e="";if(t.transaction_type==="R"||t.transaction_type==="C"?e=t.child_transaction_id===null?"Incomplete":t.child_transaction_id===t.transaction_id?"Completed":"Deposited":t.transaction_type==="D"&&(e=t.child_transaction_id===null?"Incomplete":"Accepted"),u.appendChild(Utilities.CreateTableCell("td",e,"has-text-left")),u.appendChild(Utilities.CreateTableCell("td",t.department_name,"has-text-left")),u.appendChild(Utilities.CreateTableCell("td",t.received_from,"has-text-left")),u.appendChild(Utilities.CreateTableCell("td",t.total_check_count.toString(),"has-text-right")),u.appendChild(Utilities.CreateTableCell("td",Utilities.Format_Amount(t.total_check_amount),"has-text-right")),u.appendChild(Utilities.CreateTableCell("td",Utilities.Format_Amount(t.total_cash_amount),"has-text-right")),u.appendChild(Utilities.CreateTableCell("td",Utilities.Format_Amount(t.total_check_amount+t.total_cash_amount),"has-text-right")),!r){let r=document.createElement("td");r.classList.add("has-text-right");let f=i.CreateTableCellIconButton("fa-print","is-small");f.onclick=()=>{n.ShowReceipt(t.transaction_id)};r.appendChild(f);u.appendChild(r)}return u}static CreateTableCellIconButton(n,t){let i=document.createElement("a");i.classList.add("button",t);let r=document.createElement("span");r.classList.add("icon",t);let u=document.createElement("i");return u.classList.add("fas",n),r.appendChild(u),i.appendChild(r),i}SaveNewPaymentTypes(){if(console.log("save new payment types",this.payment_type_data),this.transaction_id===-1){alert("There was an error attempting to save this transaction.  The transaction id is unknown.");return}let t=[];for(let n of this.payment_type_data)n.transaction_payment_type_id===-1&&(n.transaction_id=this.transaction_id,n.added_after_save=!0,t.push(n));if(!this.ValidateNewPaymentTypes(t)){console.log("failed to validate new payment types");return}let i=n.GetPath();Utilities.Post_Empty(i+"API/Transaction/AddPaymentTypes",t).then(t=>{console.log("response",t),t.ok?t.text().then(t=>{console.log("response text",t),t.length>0?alert("An error occurred attempting to save this payment type:\r\n"+t):n.ShowReceiptDetail(this.transaction_id)}):alert("An error occurred attempting to save this payment type:\r\n"+t.text)})}static CreateAcceptDepositMenu(t){t.transaction_type="C";let s=document.createDocumentFragment(),r=document.createElement("div");r.classList.add("columns","is-multiline");s.appendChild(r);let f=n.ControlGroup.CreateInput("number",15,!0,"Cash Amount"),h=n.ControlGroup.CreateInputFieldContainer(f,"Cash Amount Collected",!0,"is-one-quarter");r.appendChild(h);f.oninput=()=>{t.total_cash_amount=0,n.ControlGroup.ValidateMoney(f,h)&&(t.total_cash_amount=f.valueAsNumber)};let e=n.ControlGroup.CreateInput("number",15,!0,"Check Amount"),c=n.ControlGroup.CreateInputFieldContainer(e,"Check Amount Collected",!0,"is-one-quarter");r.appendChild(c);e.oninput=()=>{t.total_check_amount=0,n.ControlGroup.ValidateMoney(e,c)&&(t.total_check_amount=e.valueAsNumber)};let o=n.ControlGroup.CreateInput("number",15,!0,"# of Checks"),l=n.ControlGroup.CreateInputFieldContainer(o,"# of Checks",!0,"is-one-quarter");r.appendChild(l);o.oninput=()=>{t.total_check_count=0,n.ControlGroup.ValidateNumber(o,l)&&(t.total_check_count=o.valueAsNumber)};let i=document.createElement("textarea");i.maxLength=500;i.required=!1;i.classList.add("textarea","is-normal");i.rows=4;i.value="";i.oninput=()=>{t.comment=i.value};let a=n.ControlGroup.CreateInputFieldContainer(i,"Comments ** optional",!0,"is-half");r.appendChild(a);let u=document.createElement("button");u.classList.add("button","is-success");u.appendChild(document.createTextNode("Create Receipt For This Deposit"));u.onclick=()=>{if(console.log("Create C Transaction",t),Utilities.Toggle_Loading_Button(u,!0),t.total_cash_amount===0&&t.total_check_amount===0&&t.comment.length===0){alert("In order to create a receipt for this deposit, you must enter this information.");return}let i=n.GetPath();Utilities.Post(i+"API/Transaction/Save",t).then(function(t){n.currentReceipt.ShowReceipt(t);n.ResetReceipt();n.GetTransactionList(n.current_page,!1).then(()=>{Utilities.Toggle_Loading_Button(u,!1)})},function(n){console.log("post error occurred",n)})};let v=n.ControlGroup.CreateInputFieldContainer(u,"",!0,"is-one-quarter");return r.appendChild(v),s}static SaveDepositReceipt(){}}i.reload_button="filterRefreshButton";i.action_container="action_view";i.transaction_view_container="transaction_view";i.transaction_list_view_container="transaction_list_view";i.transaction_view_filters_container="transaction_view_filters";t.TransactionData=i})(t=n.Data||(n.Data={}))}(Transaction||(Transaction={}));